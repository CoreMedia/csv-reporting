package com.coremedia.csv.constants;

/**
 * Contains all constant string values used in between the CSV reporting and the CSV uploader tools.
 */
public class CSVConstants {
     ...
     * String.
     */
    public static String PROPERTY_PREFIX_LOCAL_SETTINGS = PROPERTY_LOCAL_SETTINGS + ".";

    /**
     * The path in the local settings for the value of the content's Product Ids.
     */
    public static String PROPERTY_LOCAL_SETTINGS_PATH_PRODUCT_IDS = "commerce.references";

    /**
     * The path in the local settings for the value of the content's Unmapped Product Keys.
     */
    public static String PROPERTY_LOCAL_SETTINGS_PATH_UNMAPPED_PRODUCT_KEYS = "sharepoint.productKeys";
    ...
    /**
     * The name of the column containing a content's Product Ids.
     */
    public static String COLUMN_PRODUCT_IDS = "ProductIds";

    /**
     * The content's path in its local settings which contains the value for its Product Ids.
     */
    public static String PROPERTY_PRODUCT_IDS = PROPERTY_PREFIX_LOCAL_SETTINGS +
            PROPERTY_LOCAL_SETTINGS_PATH_PRODUCT_IDS;

    /**
     * The name of the column containing a content's Product Keys.
     */
    public static String COLUMN_UNMAPPED_PRODUCT_KEYS = "UnmappedProductKeys";

    /**
     * The content's path in its local settings which contains the value for its Unmapped Product Keys.
     */
    public static String PROPERTY_UNMAPPED_PRODUCT_KEYS = PROPERTY_PREFIX_LOCAL_SETTINGS +
            PROPERTY_LOCAL_SETTINGS_PATH_UNMAPPED_PRODUCT_KEYS;
